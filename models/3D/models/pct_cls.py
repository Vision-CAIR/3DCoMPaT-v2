...
class Point_Transformer2(nn.Module):
    def __init__(self, output_channels=40, normal_channel=True):
        ...
        self.gather_local_0 = Local_op(in_channels=67, out_channels=128)
        self.gather_local_1 = Local_op(in_channels=131, out_channels=256)
...
def get_model(output_channels=40, normal_channel=True):
    return Point_Transformer2(output_channels)
