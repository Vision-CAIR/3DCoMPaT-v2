...
def parse_args():
    ...
    parser.add_argument('--num_category', default=42, type=int, choices=[10, 40],  help='training on ModelNet10/40')
...
def main(args):
    ...
    TEST_DATASET = Compat(data_root =root, num_points=args.num_point, split='test', transform=None)
